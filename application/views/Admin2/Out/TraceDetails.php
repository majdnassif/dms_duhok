    ...
    <div class="row">
        <div class="col-md-6">
            <table class="table table-bordered table-striped">
                <tr>
                    ...
                    <td><?= $trace['import_trace_type_name']; ?></td>
                </tr>
                <tr>
        ...
        <div class="col-md-6">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    <th><?= $this->Dictionary->GetKeyword('Received Date'); ?></th>
                    <td><?= $trace['import_trace_received_date'] ? date('Y-m-d', strtotime($trace['import_trace_received_date'])) : ''; ?></td>
                </tr>
            </table>
        </div>
    </div>
