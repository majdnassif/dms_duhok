    ...
    <section class="content">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('Import/Edit/' . $import['import_id'], ['class' => 'form-horizontal', 'id' => 'import-form']); ?>
                
                <div class="row">
                    <div class="col-md-6">
<!--                        <div class="form-group">-->
<!--                            <label class="control-label col-md-4">--><?php //= $this->Dictionary->GetKeyword('Import Code'); ?><!-- *</label>-->
<!--                            <div class="col-md-8">-->
<!--                                <input type="text" name="import_code" class="form-control" value="--><?php //= $import['import_code']; ?><!--" required>-->
<!--                            </div>-->
<!--                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="import_book_number" class="form-control" value="<?= $import['import_book_number']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="date" name="import_book_date" class="form-control" value="<?= $import['import_book_date'] ? date('Y-m-d', strtotime($import['import_book_date'])) : ''; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="date" name="import_received_date" class="form-control" value="<?= $import['import_received_date'] ? date('Y-m-d', strtotime($import['import_received_date'])) : ''; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="import_incoming_number" class="form-control" value="<?= $import['import_incoming_number']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="import_signed_by" class="form-control" value="<?= $import['import_signed_by']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="checkbox" name="import_is_direct" value="1" <?= $import['import_is_direct'] ? 'checked' : ''; ?>>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="checkbox" name="import_is_answer" id="import_is_answer" value="1" <?= $import['import_is_answer'] ? 'checked' : ''; ?>>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="text" id="import_to_department" class="form-control" value="<?= $import['import_to_department']; ?>" readonly required>
                                    <input type="hidden" id="import_to_department_id" name="import_to_department_id" value="<?= $import['import_to_department_id']; ?>" required>
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button" onclick="OpenTree('department','import_to_department','import_to_department_id','1')">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="text" id="import_from_department" class="form-control" value="<?= $import['import_from_department']; ?>" readonly required>
                                    <input type="hidden" id="import_from_department_id" name="import_from_department_id" value="<?= $import['import_from_department_id']; ?>" required>
                                    <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select name="import_book_category_id" class="form-control">
                                    ...
                                    ?>
                                    <option value="<?= $category->book_category_id ?>" <?= ($import['import_book_category_id'] == $category->book_category_id) ? 'selected' : ''; ?>><?= $category->book_category_name ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select name="import_book_language_id" class="form-control">
                                    <option value=""><?= $this->Dictionary->GetKeyword('Select'); ?></option>
                                    <?php 
                                    $languages = $this->db->get('book_language')->result();
                                    foreach($languages as $language): 
                                    ?>
                                    <option value="<?= $language->book_language_id ?>" <?= ($import['import_book_language_id'] == $language->book_language_id) ? 'selected' : ''; ?>><?= $language->book_language_name ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select name="import_book_importance_level_id" class="form-control">
                                    ...
                                    ?>
                                    <option value="<?= $level->book_importance_level_id ?>" <?= ($import['import_book_importance_level_id'] == $level->book_importance_level_id) ? 'selected' : ''; ?>><?= $level->book_importance_level_name ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-2"><?= $this->Dictionary->GetKeyword('Book Subject'); ?> *</label>
                            <div class="col-md-10">
                                <input type="text" name="import_book_subject" class="form-control" value="<?= $import['import_book_subject']; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="import_note" class="form-control" rows="5"><?= $import['import_note']; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger" onclick="deleteAttachment(<?= $import['import_id']; ?>, <?= $index; ?>)">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div >
                            ...
                            <a href="<?= base_url('Import/Details/' . $import['import_id']); ?>" class="btn btn-default">
                            ...
                            <div class="panel-body">
                                ...
                                <?php else: ?>
                                    <div class="alert alert-info">
                                        <?= $this->Dictionary->GetKeyword('No Answer records found for this document.'); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<div class="modal fade" id="addAnswerModal" tabindex="-1" role="dialog" aria-labelledby="addAnswerModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="addAnswerForm" action="<?= base_url('Import/AjaxAddAnswer'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row answer-row">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control department-text" id="answer_out_to_department" name="answer_out_to_department"  readonly required>
                                        <input type="hidden" class="form-control department-id" id="answer_out_to_department_id" name="answer_out_to_department_id" required>
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" type="button" onclick="OpenTree('department','answer_out_to_department','answer_out_to_department_id','1', 'extra-section', 1)">
                                                <i class="fa fa-search"></i>
                                            </button>
                                        </span>
                                    </div>
...
<script>
    $(document).ready(function(){
        ...
        if ($('#import_is_answer').is(':checked')) {
    ...
    function deleteAttachment(importId, fileIndex) {
