                ...
                <form id="AddUserForm" class="col-xs-12">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="department_name" value="<?= $User['user_department_name'] ?>" onclick="OpenTree('department','department_name','user_department_id','1', 'extra-section', 1)" readonly="">
                            <input type="hidden" class="form-control" id="user_department_id" name="user_department_id" value="<?=$User['user_department_id']?>">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="user_access_department_id"><?= $this->Dictionary->GetKeyword('user_access_department')?>*</label>
                            <input type="text" class="form-control" id="access_department_name" value="<?= $User['access_department_name'] ?>" onclick="OpenTree('department','access_department_name','user_access_department_id','1', 'extra-section', 1)" readonly="">
                            <input type="hidden" class="form-control" id="user_access_department_id" name="user_access_department_id" value="<?=$User['user_access_department_id']?>">
                        </div>
