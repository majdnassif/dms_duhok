class KurdishSoraniNumbersToWords {
    ...
    static convert(number){
        if (typeof number !== 'number'){
            ...
            } else if (this._get_number_type(number) === 'billion'){
                return this._calculate_billion(number)
            } else if (this._get_number_type(number) === 'tens-billion'){
                return this._calculate_tens_billion(number)
            } else if (this._get_number_type(number) === 'hundreds-billion'){
                return this._calculate_hundreds_billion(number)
    ...
    static _calculate_billion(n){
        ...
        if (n.endsWith('000000000')){
            ...
            if (n.startsWith('5')){
                ...
                return this._calculate_ones(current_n) + ' ' + 'ملیار'
            }
        }
        ...
        switch (rest_int.toString().length){
            ...
            case 7: {
                rest = this._calculate_millions(rest_int.toString())
                break
            }
            case 8: {
                rest = this._calculate_tens_millions(rest_int.toString())
                break
            }
            default: {
                rest = this._calculate_hundreds_millions(rest_int.toString())
                break
            }
        }

        if (n.startsWith('5')){
            return 'پێنج' + ' ' + 'ملیار' + this._get_joint() + rest
        }else if (n.startsWith('1')){
            return 'ملیار' + this._get_joint() + rest
        }else {
            const current_n = parseInt(n.substr(0, 1))
            return this._calculate_ones(current_n.toString()) + ' ' + 'ملیار' + this._get_joint() + rest
        }
    }

    static _calculate_tens_billion(n){
        //hezar
        if (n.endsWith('000000000')){
            const current_n = n.substr(0, 2)
            return this._calculate_tens(current_n) + ' ' + 'ملیار'
        }
        ...
        const current_n = parseInt(n.substr(0, 2))
        return this._calculate_tens(current_n.toString()) + ' ' + 'ملیار' + this._get_joint() + rest

    }

    static _calculate_hundreds_billion(n){
        //hezar
        if (n.endsWith('000000000')){
            const current_n = n.substr(0, 3)
            return this._calculate_hundreds(current_n) + ' ' + 'ملیار'
        }
        ...
        const current_n = parseInt(n.substr(0, 3))
        return this._calculate_hundreds(current_n.toString()) + ' ' + 'ملیار' + this._get_joint() + rest
