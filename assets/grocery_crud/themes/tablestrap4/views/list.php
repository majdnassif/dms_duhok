			...
			<td class='actions'>
				<?php if(!empty($row->action_urls)){
					foreach($row->action_urls as $action_unique_id => $action_url){
						...
						if($action_unique_id!='add_modal'){
						 ?>
						<a href="<?php echo $action_url; ?>" class="edit_button btn btn-xs <?php if($action->btn_css_class!=''){echo $action->btn_css_class;}else{echo 'btn-primary';};?>" role="button">
							<i class="fa fa-<?php echo $action->css_class; ?> <?php echo $action_unique_id;?>"></i>
